...
class AppTextFormFieldPasswordWidget extends AppTextFormField {
  ...
  @override
  State<AppTextFormFieldPasswordWidget> createState() => _AppTextFormFieldPasswordState();
}

class _AppTextFormFieldPasswordState extends State<AppTextFormFieldPasswordWidget> {
...
class AppTextFormField extends StatefulWidget {
  ...
  final List<ValueObjectInterface>? validator;
...
class _AppTextFormFieldState extends State<AppTextFormField> {
  ...
  @override
  void initState() {
    borderRadius = widget.isTextArea ? 15 : 10;
    super.initState();
  }
  ...
  void didChangeDependencies() {
    border = widget.enableBorder
        ? OutlineInputBorder(
            ...
            borderSide: BorderSide(color: widget.borderColor ?? Theme.of(context).colorScheme.outline, width: 1.0),
          )
        : null;
  ...
  String? validator(String? v) {
    ...
    if (widget.validator != null) {
      widget.validator?.forEach((element) {
        var error = element.validator(v ?? '');
